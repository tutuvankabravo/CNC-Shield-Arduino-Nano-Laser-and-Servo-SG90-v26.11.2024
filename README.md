...
$22 = 1 //(Homing cycle enable, boolean 0 - поиск домашней позиции отключена, 1 - домашняя позиция включена)//  
...
Сочетание кнопок:  
Кнопки UP+DOWN - Однократное нажатие. Поиск Дома (станок будет двигаться в заранее установленные нулевые координаты ( от большего числа к меньшему ) $22 = 1, $21 = 1,$ = 24 ).  
Кнопки UP+START - Если удерживать то будет движение по оси X ( от меньшего числа к большему ), (скорость поиска дома $ = 24, $21 = 1 ).  
Кнопки DOWN+START - Если удерживать то будет движение по оси Y ( от меньшего числа к большему ), (скорость поиска дома $ = 24, $21 = 1 ).  
